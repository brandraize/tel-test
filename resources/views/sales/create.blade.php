...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h4 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Add {{ ucfirst($category) }} Sale</h4>
        <p class="text-muted mb-0">Record a new transaction for the {{ ucfirst(str_replace('_', ' ', $category)) }} category.</p>
    </div>
    <a href="{{ route('sales.index', ['category' => $category]) }}" class="btn btn-outline-secondary">
        <i class="fas fa-arrow-left me-1"></i> Back to {{ ucfirst($category) }} Sales
    </a>
</div>
        ...
        <form action="{{ route('sales.store') }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="total_items" name="total_items" value="{{ old('total_items') }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="net_profit" name="net_profit" value="{{ old('net_profit') }}"
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" id="wasool" name="wasool" value="{{ old('wasool') }}"
                ...
                <div class="col-md-6">
                    ...
                    <textarea id="notes" name="notes" rows="3"
                              class="form-control" placeholder="Optional notes or details">{{ old('notes') }}</textarea>
                </div>
            </div>
